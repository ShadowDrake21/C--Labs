...
namespace Lab2_basic_work
{
    class StudentRepository : IStudentRepository
    {
        ...
        private NpgsqlConnection getConnection()
        {
            if (null == connection)
            {
                String connectionStr = "Server=127.0.0.1;Port=5432;User Id=postgres;Password=111111;Database=university;";
        ...
        public void Save(Student student)
        {
            ...
            addParameterToCommand(command, "@firstname", DbType.String, student.FirstName);
            addParameterToCommand(command, "@lastname", DbType.String, student.LastName);
            addParameterToCommand(command, "@sex", DbType.String, student.Sex);
            addParameterToCommand(command, "@age", DbType.Int32, student.Age);
        ...
        public void Update(Student student)
        {
            ...
            addParameterToCommand(command, "@id", DbType.Int64, student.Id);
            addParameterToCommand(command, "@firstname", DbType.String, student.FirstName);
            addParameterToCommand(command, "@lastname", DbType.String, student.LastName);
            addParameterToCommand(command, "@sex", DbType.String, student.Sex);
            addParameterToCommand(command, "@age", DbType.Int32, student.Age);
